// Блок look-how. При клике на кнопку делаем ей стиль активной кнопки. С той кнопки, что до этого была активной, убираем стиль активной кнопки. Переключаемся между фотграфиями комнат со стикерами.
